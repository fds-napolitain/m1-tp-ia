...
public abstract class Constraint {
	...
	protected List<String> varList;	// portée de la contrainte : la liste des différentes variables
	 ...
	 * 
	 */
	public Constraint(List<String> vars) {
		num++;
		this.name = "C"+num;
		varList = vars; 
	}
	 ...
	 */
	public Constraint(List<String> vars, String name) {
		num++;
		this.name = name;
		varList = vars; 
	}
