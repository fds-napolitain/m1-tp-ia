...
public class Network {
	 ...
	 */
	public Network() {
		varDom = new HashMap<String,List<Object>>();
	...
	public List<Constraint> getConstraints(String var) {						
		List<Constraint> selected = new ArrayList<Constraint>();
	...
	public static void main(String[] args){
		...
		monCSP.addVariable(v1); // vardom (string, arraylist<object>) et map donc pas de duplicata
		...
		monCSP.addValue(v3,2);
		// les contraintes
		List<String> varTuple;
		List<Object> valTuple;
